...
$common_tests = [
    ...
    'Lipid Profile', 'Liver Function Test (LFT)', 'Kidney Function Test (KFT)', 'Thyroid Function Test',
    'Urine Routine', 'Dengue NS1 Antigen', 'Dengue IgM/IgG', 'Malaria Test', 'Typhoid Test',
    'X-Ray Chest', 'ECG', 'Ultrasound', 'CT Scan', 'MRI'
];
?>
...
<div class="container">
    <div class="page-header">
        ...
        <a href="laboratory.php" class="btn btn-secondary">
